...
import { SEARCH_LINE } from 'src/constants/notes/actionTypes';
...
export function SearchBar() {
  ...
  return (
    <div className={classes.searchBar}>
      <input onChange={searchHandler} className={classes.searchField} placeholder={SEARCH} value={state.searchLine}></input>
